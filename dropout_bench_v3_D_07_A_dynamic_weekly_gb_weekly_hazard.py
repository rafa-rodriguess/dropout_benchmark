...
"""
Production not-weighted gradient-boosted weekly hazard benchmark module for stage D5.7b.
...
Expected outputs:
- DuckDB tables table_gb_weekly_hazard_not_weighted_preprocessing_summary, table_gb_weekly_hazard_not_weighted_raw_feature_manifest,
  table_gb_weekly_hazard_not_weighted_feature_names_out, table_gb_weekly_hazard_not_weighted_guardrails,
  table_gb_weekly_hazard_not_weighted_tuning_results, table_gb_weekly_hazard_not_weighted_tuned_test_predictions,
  table_gb_weekly_hazard_not_weighted_tuned_primary_metrics, table_gb_weekly_hazard_not_weighted_tuned_brier_by_horizon,
  table_gb_weekly_hazard_not_weighted_tuned_secondary_metrics, table_gb_weekly_hazard_not_weighted_tuned_td_auc_support_audit,
  table_gb_weekly_hazard_not_weighted_tuned_row_diagnostics, table_gb_weekly_hazard_not_weighted_tuned_support_by_horizon,
  table_gb_weekly_hazard_not_weighted_tuned_calibration_summary, table_gb_weekly_hazard_not_weighted_tuned_calibration_bins_by_horizon,
  table_gb_weekly_hazard_not_weighted_tuned_predicted_vs_observed_survival
- outputs_benchmark_survival/metadata/gb_weekly_hazard_not_weighted_preprocessing_config.json
- outputs_benchmark_survival/metadata/gb_weekly_hazard_not_weighted_tuned_model_config.json
- outputs_benchmark_survival/models/gb_weekly_hazard_not_weighted_tuned.joblib
- outputs_benchmark_survival/models/gb_weekly_hazard_not_weighted_preprocessor.joblib
...
- table_gb_weekly_hazard_not_weighted_preprocessing_summary
- table_gb_weekly_hazard_not_weighted_raw_feature_manifest
- table_gb_weekly_hazard_not_weighted_feature_names_out
- table_gb_weekly_hazard_not_weighted_guardrails
- table_gb_weekly_hazard_not_weighted_tuning_results
- table_gb_weekly_hazard_not_weighted_tuned_test_predictions
- table_gb_weekly_hazard_not_weighted_tuned_primary_metrics
- table_gb_weekly_hazard_not_weighted_tuned_brier_by_horizon
- table_gb_weekly_hazard_not_weighted_tuned_secondary_metrics
- table_gb_weekly_hazard_not_weighted_tuned_td_auc_support_audit
- table_gb_weekly_hazard_not_weighted_tuned_row_diagnostics
- table_gb_weekly_hazard_not_weighted_tuned_support_by_horizon
- table_gb_weekly_hazard_not_weighted_tuned_calibration_summary
- table_gb_weekly_hazard_not_weighted_tuned_calibration_bins_by_horizon
- table_gb_weekly_hazard_not_weighted_tuned_predicted_vs_observed_survival
- pipeline_table_catalog
...
NOTEBOOK_NAME = "dropout_bench_v3_D_5_7_not_weighted.ipynb"
MODEL_NAME = "gb_weekly_hazard_not_weighted_tuned"
PREPROCESSING_CONFIG_NAME = "gb_weekly_hazard_not_weighted_preprocessing_config.json"
MODEL_CONFIG_NAME = "gb_weekly_hazard_not_weighted_tuned_model_config.json"
MODEL_ARTIFACT_NAME = "gb_weekly_hazard_not_weighted_tuned.joblib"
PREPROCESSOR_ARTIFACT_NAME = "gb_weekly_hazard_not_weighted_preprocessor.joblib"
...
def initialize_context() -> base.base.PipelineContext:
	...
	base.base.log_stage_start("5.7b.1", "Lightweight runtime bootstrap for the not-weighted gradient-boosted weekly hazard benchmark")
...
# - gb_weekly_hazard_not_weighted_preprocessing_config.json
...
def build_dynamic_treatment(ctx: base.base.PipelineContext, window_weeks: int) -> base.base.DynamicTreatmentState:
	base.base.log_stage_start("5.7b.2", "Prepare the shared dynamic weekly treatment for the not-weighted gradient-boosted benchmark")
	...
	if len(feature_names_out) == 0:
		raise ValueError("Not-weighted gradient-boosted weekly hazard preprocessing produced zero output features.")
	...
	base.base.materialize_dataframe_table(
		...
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_preprocessing_summary", window_weeks),
		block_number="5.7b.2",
		label=f"Stage 5.7b.2 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_preprocessing_summary', output_table_suffix)} — Not-weighted gradient-boosted preprocessing summary",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=feature_manifest_df,
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_raw_feature_manifest", window_weeks),
		block_number="5.7b.2",
		label=f"Stage 5.7b.2 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_raw_feature_manifest', output_table_suffix)} — Not-weighted gradient-boosted raw feature manifest",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=feature_names_df,
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_feature_names_out", window_weeks),
		block_number="5.7b.2",
		label=f"Stage 5.7b.2 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_feature_names_out', output_table_suffix)} — Not-weighted gradient-boosted transformed feature names",
	)
	...
	preprocessing_config = {
		...
		"train_event_rate": float(y_train.mean()),
		"test_event_rate": float(y_test.mean()),
		"design_note": "The not-weighted gradient-boosted weekly hazard benchmark reuses the same weekly dynamic treatment contract as D5.7 while removing positive-class weighting only.",
	...
	base.base.print_artifact("gb_weekly_hazard_not_weighted_preprocessing_config", str(preprocessing_config_path))
...
# Outputs:
# - table_gb_weekly_hazard_not_weighted_guardrails in DuckDB
...
def build_guardrails(ctx: base.base.PipelineContext, treatment: base.base.DynamicTreatmentState, window_weeks: int) -> dict[str, object]:
	base.base.log_stage_start("5.7b.3", "Compute runtime guardrails for the not-weighted gradient-boosted weekly hazard model")
	output_table_suffix = build_dynamic_window_suffix(window_weeks)
	...
	base.base.materialize_dataframe_table(
		...
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_guardrails", window_weeks),
		block_number="5.7b.3",
		label=f"Stage 5.7b.3 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_guardrails', output_table_suffix)} — Not-weighted gradient-boosted runtime guardrails",
	)
...
# - gb_weekly_hazard_not_weighted_tuned.joblib
# - gb_weekly_hazard_not_weighted_preprocessor.joblib
# - gb_weekly_hazard_not_weighted_tuned_model_config.json
def tune_and_evaluate_gb_weekly_hazard_model(
	...
	base.base.log_stage_start("5.7b.4", "Tune and evaluate the not-weighted gradient-boosted weekly hazard model")
	output_table_suffix = build_dynamic_window_suffix(window_weeks)
	...
	base.base.materialize_dataframe_table(
		...
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuning_results", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuning_results', output_table_suffix)} — Not-weighted gradient-boosted tuning results",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=test_predictions_df,
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_test_predictions", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_test_predictions', output_table_suffix)} — Not-weighted gradient-boosted test predictions",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=artifacts["primary_metrics_df"],
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_primary_metrics", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_primary_metrics', output_table_suffix)} — Not-weighted gradient-boosted primary metrics",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=artifacts["brier_by_horizon_df"],
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_brier_by_horizon", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_brier_by_horizon', output_table_suffix)} — Not-weighted gradient-boosted Brier scores by horizon",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=artifacts["secondary_metrics_df"],
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_secondary_metrics", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_secondary_metrics', output_table_suffix)} — Not-weighted gradient-boosted secondary metrics",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=artifacts["td_auc_support_audit_df"],
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_td_auc_support_audit", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_td_auc_support_audit', output_table_suffix)} — Not-weighted gradient-boosted IPCW support audit",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=artifacts["row_diagnostics_df"],
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_row_diagnostics", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_row_diagnostics', output_table_suffix)} — Not-weighted gradient-boosted row-level diagnostics",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=artifacts["support_by_horizon_df"],
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_support_by_horizon", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_support_by_horizon', output_table_suffix)} — Not-weighted gradient-boosted support by horizon",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=artifacts["calibration_summary_df"],
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_calibration_summary", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_calibration_summary', output_table_suffix)} — Not-weighted gradient-boosted calibration summary",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=artifacts["calibration_bins_df"],
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_calibration_bins_by_horizon", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_calibration_bins_by_horizon', output_table_suffix)} — Not-weighted gradient-boosted calibration bins",
	)
	base.base.materialize_dataframe_table(
		ctx,
		df=artifacts["predicted_vs_observed_survival_df"],
		table_name=apply_window_table_name("table_gb_weekly_hazard_not_weighted_tuned_predicted_vs_observed_survival", window_weeks),
		block_number="5.7b.4",
		label=f"Stage 5.7b.4 {apply_name_suffix('table_gb_weekly_hazard_not_weighted_tuned_predicted_vs_observed_survival', output_table_suffix)} — Not-weighted gradient-boosted predicted versus observed survival",
	)
	...
	config_payload = {
		...
		"calibration_contract_version": base.base.CALIBRATION_CONTRACT_VERSION,
		"calibration_observed_risk_method": base.base.CALIBRATION_OBSERVED_RISK_METHOD,
		"active_window_weeks": int(window_weeks),
		"best_candidate": {
		...
		"weighting_strategy": "none; this official D5.7 variant preserves the same candidate grid and evaluation contract without positive-class weighting.",
		"design_note": "This variant keeps the same weekly benchmark arm, feature contract, and conservative boosted configuration while leaving positive-class weighting exclusively to the weighted sensitivity counterpart.",
	}
	base.base.save_json(config_payload, config_path)
	base.base.print_artifact("gb_weekly_hazard_not_weighted_model", str(model_path))
	base.base.print_artifact("gb_weekly_hazard_not_weighted_preprocessor", str(preprocessor_path))
	base.base.print_artifact("gb_weekly_hazard_not_weighted_tuned_model_config", str(config_path))
