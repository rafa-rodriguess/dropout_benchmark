...
"""
Production not-weighted linear discrete-time hazard benchmark module for the official D5.2 arm.
...
Expected outputs:
- DuckDB tables table_p16_linear_not_weighted_treatment_audit, table_p16_linear_not_weighted_feature_manifest,
  table_p16_linear_not_weighted_canonical_alignment, table_p16_linear_not_weighted_output_feature_manifest,
  table_linear_not_weighted_tuning_results, table_linear_not_weighted_tuned_test_predictions,
  table_linear_not_weighted_tuned_primary_metrics, table_linear_not_weighted_tuned_brier_by_horizon,
  table_linear_not_weighted_tuned_secondary_metrics, table_linear_not_weighted_tuned_td_auc_support_audit,
  table_linear_not_weighted_tuned_row_diagnostics, table_linear_not_weighted_tuned_support_by_horizon,
  table_linear_not_weighted_tuned_calibration_summary, table_linear_not_weighted_tuned_calibration_bins_by_horizon,
  table_linear_not_weighted_tuned_predicted_vs_observed_survival
- outputs_benchmark_survival/metadata/metadata_p16_linear_not_weighted_treatment.json
- outputs_benchmark_survival/metadata/linear_not_weighted_tuned_model_config.json
- outputs_benchmark_survival/models/linear_discrete_time_hazard_not_weighted_tuned.joblib
- outputs_benchmark_survival/models/linear_discrete_time_not_weighted_preprocessor.joblib
...
- table_p16_linear_not_weighted_treatment_audit
- table_p16_linear_not_weighted_feature_manifest
- table_p16_linear_not_weighted_canonical_alignment
- table_p16_linear_not_weighted_output_feature_manifest
- table_linear_not_weighted_tuning_results
- table_linear_not_weighted_tuned_test_predictions
- table_linear_not_weighted_tuned_primary_metrics
- table_linear_not_weighted_tuned_brier_by_horizon
- table_linear_not_weighted_tuned_secondary_metrics
- table_linear_not_weighted_tuned_td_auc_support_audit
- table_linear_not_weighted_tuned_row_diagnostics
- table_linear_not_weighted_tuned_support_by_horizon
- table_linear_not_weighted_tuned_calibration_summary
- table_linear_not_weighted_tuned_calibration_bins_by_horizon
- table_linear_not_weighted_tuned_predicted_vs_observed_survival
- pipeline_table_catalog
...
NOTEBOOK_NAME = "dropout_bench_v3_D_5_2_not_weighted.ipynb"
PREVIEW_ROWS = 20
...
def build_linear_treatment(ctx: PipelineContext, run_spec: WindowRunSpec) -> LinearTreatmentState:
    ...
    # - DuckDB audit tables and metadata_p16_linear_not_weighted_treatment.json
    ...
    materialize_dataframe_table(
        ctx,
        df=preproc_audit_df,
        table_name=apply_name_suffix("table_p16_linear_not_weighted_treatment_audit", run_spec.output_suffix),
        block_number="5.2.2",
        label=f"Stage 5.2.2 {apply_name_suffix('table_p16_linear_not_weighted_treatment_audit', run_spec.output_suffix)} — Linear treatment audit",
    )
    materialize_dataframe_table(
        ctx,
        df=feature_manifest_df,
        table_name=apply_name_suffix("table_p16_linear_not_weighted_feature_manifest", run_spec.output_suffix),
        block_number="5.2.2",
        label=f"Stage 5.2.2 {apply_name_suffix('table_p16_linear_not_weighted_feature_manifest', run_spec.output_suffix)} — Linear feature manifest",
    )
    materialize_dataframe_table(
        ctx,
        df=canonical_alignment_df,
        table_name=apply_name_suffix("table_p16_linear_not_weighted_canonical_alignment", run_spec.output_suffix),
        block_number="5.2.2",
        label=f"Stage 5.2.2 {apply_name_suffix('table_p16_linear_not_weighted_canonical_alignment', run_spec.output_suffix)} — Canonical feature alignment",
    )
    materialize_dataframe_table(
        ctx,
        df=output_feature_manifest_df,
        table_name=apply_name_suffix("table_p16_linear_not_weighted_output_feature_manifest", run_spec.output_suffix),
        block_number="5.2.2",
        label=f"Stage 5.2.2 {apply_name_suffix('table_p16_linear_not_weighted_output_feature_manifest', run_spec.output_suffix)} — Preprocessed feature manifest",
    )
    ...
    treatment_metadata_path = ctx.metadata_dir / append_suffix_before_extension(
        "metadata_p16_linear_not_weighted_treatment.json",
...
def tune_and_evaluate_linear_model(ctx: PipelineContext, treatment: LinearTreatmentState, run_spec: WindowRunSpec) -> None:
    ...
    # - linear_not_weighted_tuned_model_config.json
    ...
    for horizon_week in BENCHMARK_HORIZONS:
        ...
        horizon_predictions_df = evaluable_df.loc[
            :,
            [
                "enrollment_id",
                "event",
    ...
    model_path = ctx.models_dir / append_suffix_before_extension(
        "linear_discrete_time_hazard_not_weighted_tuned.joblib",
        run_spec.output_suffix,
    )
    preprocessor_path = ctx.models_dir / append_suffix_before_extension(
        "linear_discrete_time_not_weighted_preprocessor.joblib",
        run_spec.output_suffix,
    )
    ...
    materialize_dataframe_table(
        ...
        table_name=apply_name_suffix("table_linear_not_weighted_tuning_results", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuning_results', run_spec.output_suffix)} — Linear tuning results",
    )
    materialize_dataframe_table(
        ctx,
        df=test_predictions_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_test_predictions", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_test_predictions', run_spec.output_suffix)} — Linear test predictions",
    )
    materialize_dataframe_table(
        ctx,
        df=primary_metrics_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_primary_metrics", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_primary_metrics', run_spec.output_suffix)} — Linear primary metrics",
    )
    materialize_dataframe_table(
        ctx,
        df=brier_by_horizon_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_brier_by_horizon", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_brier_by_horizon', run_spec.output_suffix)} — Linear Brier scores by horizon",
    )
    materialize_dataframe_table(
        ctx,
        df=secondary_metrics_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_secondary_metrics", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_secondary_metrics', run_spec.output_suffix)} — Linear secondary metrics",
    )
    materialize_dataframe_table(
        ctx,
        df=time_dependent_auc_audit_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_td_auc_support_audit", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_td_auc_support_audit', run_spec.output_suffix)} — Linear IPCW support audit",
    )
    materialize_dataframe_table(
        ctx,
        df=row_diagnostics_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_row_diagnostics", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_row_diagnostics', run_spec.output_suffix)} — Linear row-level diagnostics",
    )
    materialize_dataframe_table(
        ctx,
        df=support_by_horizon_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_support_by_horizon", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_support_by_horizon', run_spec.output_suffix)} — Linear support by horizon",
    )
    materialize_dataframe_table(
        ctx,
        df=calibration_summary_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_calibration_summary", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_calibration_summary', run_spec.output_suffix)} — Linear calibration summary",
    )
    materialize_dataframe_table(
        ctx,
        df=calibration_bins_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_calibration_bins_by_horizon", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_calibration_bins_by_horizon', run_spec.output_suffix)} — Linear calibration bins",
    )
    materialize_dataframe_table(
        ctx,
        df=predicted_vs_observed_survival_df,
        table_name=apply_name_suffix("table_linear_not_weighted_tuned_predicted_vs_observed_survival", run_spec.output_suffix),
        block_number="5.2.3",
        label=f"Stage 5.2.3 {apply_name_suffix('table_linear_not_weighted_tuned_predicted_vs_observed_survival', run_spec.output_suffix)} — Linear predicted versus observed survival",
    )
    ...
    config_payload = {
        ...
        "weighting_strategy": "none; this official D5.2 variant fits the same weekly dynamic feature contract without class reweighting.",
        "design_note": "The repaired IPCW-supported time-dependent AUC path is integrated directly into this not-weighted D5.2 official variant so the Item 6 comparison changes only the fitting weights in the weighted sensitivity counterpart, not the evaluation stack.",
    }
