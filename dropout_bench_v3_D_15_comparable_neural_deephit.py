...
"""
Production Neural-DeepHit benchmark module for stage D5.15.
...
- applies deterministic preprocessing and feature validation for the Neural-DeepHit model
- tunes and fits the Neural-DeepHit benchmark under the official grouped validation protocol
...
- persists the trained model, fitted preprocessing pipeline, DuckDB audit tables, and JSON metadata artifacts
			for candidate in DEEPHIT_TUNING_GRID
Main processing purpose:
- materialize the full comparable Neural-DeepHit benchmark arm deterministically from DuckDB-ready tables without notebook runtime state, CSV workflows, or hidden execution state
...
Expected outputs:
- DuckDB tables table_deephit_preprocessing_summary, table_deephit_raw_feature_manifest,
	table_deephit_feature_names_out, table_deephit_guardrails, table_deephit_tuning_results,
  table_deephit_tuned_test_predictions, table_deephit_tuned_primary_metrics,
  table_deephit_tuned_brier_by_horizon, table_deephit_tuned_secondary_metrics,
  table_deephit_tuned_td_auc_support_audit, table_deephit_tuned_row_diagnostics,
  table_deephit_tuned_support_by_horizon, table_deephit_tuned_calibration_summary,
  table_deephit_tuned_calibration_bins_by_horizon,
  table_deephit_tuned_predicted_vs_observed_survival
- outputs_benchmark_survival/metadata/deephit_preprocessing_config.json
- outputs_benchmark_survival/metadata/deephit_tuned_model_config.json
- outputs_benchmark_survival/models/deephit_tuned.pt
- outputs_benchmark_survival/models/deephit_preprocessor.joblib
...
- table_deephit_preprocessing_summary
- table_deephit_raw_feature_manifest
- table_deephit_feature_names_out
- table_deephit_guardrails
- table_deephit_tuning_results
- table_deephit_tuned_test_predictions
- table_deephit_tuned_primary_metrics
- table_deephit_tuned_brier_by_horizon
- table_deephit_tuned_secondary_metrics
- table_deephit_tuned_td_auc_support_audit
- table_deephit_tuned_row_diagnostics
- table_deephit_tuned_support_by_horizon
- table_deephit_tuned_calibration_summary
- table_deephit_tuned_calibration_bins_by_horizon
- table_deephit_tuned_predicted_vs_observed_survival
- pipeline_table_catalog
...
NOTEBOOK_NAME = "dropout_bench_v3_D_5_15.ipynb"
MODEL_NAME = "deephit_tuned"
MODEL_IMPLEMENTATION = "pycox_deephit_single"
PREVIEW_ROWS = 20
...
DEEPHIT_MIN_DURATION = 1.0
DEEPHIT_SEARCH_ROW_CAP = 50000
DEEPHIT_FINAL_ROW_CAP = 50000
DEEPHIT_MAX_EPOCHS = 80
DEEPHIT_EARLY_STOPPING_PATIENCE = 8
...
DEEPHIT_TUNING_GRID = (
	{"candidate_id": 1,  "num_durations": 20, "hidden_dims": [64, 32],   "dropout": 0.10, "alpha": 0.2, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 2,  "num_durations": 20, "hidden_dims": [64, 32],   "dropout": 0.10, "alpha": 0.2, "sigma": 0.1, "learning_rate": 1e-2, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 3,  "num_durations": 20, "hidden_dims": [64, 32],   "dropout": 0.20, "alpha": 0.3, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-4, "batch_size": 512},
	{"candidate_id": 4,  "num_durations": 20, "hidden_dims": [64, 32],   "dropout": 0.20, "alpha": 0.3, "sigma": 0.2, "learning_rate": 1e-2, "weight_decay": 1e-4, "batch_size": 512},
	{"candidate_id": 5,  "num_durations": 20, "hidden_dims": [128, 64],  "dropout": 0.10, "alpha": 0.2, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 6,  "num_durations": 20, "hidden_dims": [128, 64],  "dropout": 0.10, "alpha": 0.2, "sigma": 0.2, "learning_rate": 1e-2, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 7,  "num_durations": 20, "hidden_dims": [128, 64],  "dropout": 0.20, "alpha": 0.3, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-4, "batch_size": 512},
	{"candidate_id": 8,  "num_durations": 20, "hidden_dims": [128, 64],  "dropout": 0.20, "alpha": 0.3, "sigma": 0.2, "learning_rate": 1e-3, "weight_decay": 1e-4, "batch_size": 1024},
	{"candidate_id": 9,  "num_durations": 20, "hidden_dims": [256, 128], "dropout": 0.10, "alpha": 0.2, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 10, "num_durations": 20, "hidden_dims": [256, 128], "dropout": 0.20, "alpha": 0.3, "sigma": 0.2, "learning_rate": 1e-3, "weight_decay": 1e-4, "batch_size": 1024},
	{"candidate_id": 11, "num_durations": 20, "hidden_dims": [256, 128], "dropout": 0.20, "alpha": 0.3, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-4, "batch_size": 512},
	{"candidate_id": 12, "num_durations": 20, "hidden_dims": [256, 128], "dropout": 0.30, "alpha": 0.2, "sigma": 0.1, "learning_rate": 1e-3, "weight_decay": 1e-4, "batch_size": 1024},
	{"candidate_id": 13, "num_durations": 40, "hidden_dims": [64, 32],   "dropout": 0.10, "alpha": 0.2, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 14, "num_durations": 40, "hidden_dims": [64, 32],   "dropout": 0.10, "alpha": 0.2, "sigma": 0.2, "learning_rate": 1e-2, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 15, "num_durations": 40, "hidden_dims": [64, 32],   "dropout": 0.20, "alpha": 0.3, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-4, "batch_size": 512},
	{"candidate_id": 16, "num_durations": 40, "hidden_dims": [64, 32],   "dropout": 0.20, "alpha": 0.3, "sigma": 0.2, "learning_rate": 1e-2, "weight_decay": 1e-4, "batch_size": 512},
	{"candidate_id": 17, "num_durations": 40, "hidden_dims": [128, 64],  "dropout": 0.10, "alpha": 0.2, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 18, "num_durations": 40, "hidden_dims": [128, 64],  "dropout": 0.10, "alpha": 0.2, "sigma": 0.2, "learning_rate": 1e-2, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 19, "num_durations": 40, "hidden_dims": [128, 64],  "dropout": 0.20, "alpha": 0.3, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-4, "batch_size": 512},
	{"candidate_id": 20, "num_durations": 40, "hidden_dims": [128, 64],  "dropout": 0.20, "alpha": 0.3, "sigma": 0.2, "learning_rate": 1e-3, "weight_decay": 1e-4, "batch_size": 1024},
	{"candidate_id": 21, "num_durations": 40, "hidden_dims": [256, 128], "dropout": 0.10, "alpha": 0.2, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-5, "batch_size": 512},
	{"candidate_id": 22, "num_durations": 40, "hidden_dims": [256, 128], "dropout": 0.20, "alpha": 0.3, "sigma": 0.1, "learning_rate": 5e-3, "weight_decay": 1e-4, "batch_size": 512},
	{"candidate_id": 23, "num_durations": 40, "hidden_dims": [256, 128], "dropout": 0.20, "alpha": 0.3, "sigma": 0.2, "learning_rate": 1e-2, "weight_decay": 1e-4, "batch_size": 1024},
	{"candidate_id": 24, "num_durations": 40, "hidden_dims": [256, 128], "dropout": 0.30, "alpha": 0.2, "sigma": 0.1, "learning_rate": 1e-3, "weight_decay": 1e-4, "batch_size": 1024},
)
...
# ==============================================================
# 5.15.1 - Lightweight runtime bootstrap
# ==============================================================
# What this block does:
# - Initializes shared paths, configuration objects, run metadata, and the DuckDB connection for the D5.15 stage.
# Inputs:
...
def initialize_context(window_weeks: int) -> PipelineContext:
	...
	log_stage_start("5.15.1", "Lightweight runtime bootstrap")
	...
	base.require_tables(con, [input_train_table, input_test_table], block_number="5.15.1")
	...
	log_stage_end("5.15.1")
	return ctx


# ==============================================================
# 5.15.2 - Build the comparable Neural-DeepHit treatment
# ==============================================================
# What this block does:
...
# Outputs:
# - files generated: outputs_benchmark_survival/metadata/deephit_preprocessing_config.json, outputs_benchmark_survival/models/deephit_preprocessor.joblib
# - DuckDB tables created or updated: table_deephit_preprocessing_summary, table_deephit_raw_feature_manifest, table_deephit_feature_names_out
# - objects returned in memory: DeepHitTreatmentState
def build_deephit_treatment(ctx: PipelineContext) -> DeepHitTreatmentState:
	log_stage_start("5.15.2", "Build comparable Neural-DeepHit treatment")
	...
	if sorted(expected_numeric_features) != sorted(numeric_features):
		raise ValueError(
			"The comparable Neural-DeepHit numeric feature specification does not match the canonical modeling contract. "
	...
	train_df = base.load_required_table(ctx, ctx.input_train_table, required_columns, block_number="5.15.2")
	test_df = base.load_required_table(ctx, ctx.input_test_table, required_columns, block_number="5.15.2")
	...
	if X_train.ndim != 2 or X_test.ndim != 2:
		raise ValueError(f"The Neural-DeepHit transformed matrices must be 2D. Got train={X_train.shape}, test={X_test.shape}.")
	if not np.isfinite(X_train).all() or not np.isfinite(X_test).all():
		raise ValueError("The Neural-DeepHit transformed matrices contain non-finite values.")
		...
		[
			{
				...
				"model_positioning_note": "early-window comparable Neural-DeepHit benchmark",
	...
	base.materialize_dataframe_table(
		...
		table_name=base.artifact_name(ctx, "table_deephit_preprocessing_summary"),
		block_number="5.15.2",
		label="Stage 5.15.2 table_deephit_preprocessing_summary - Neural-DeepHit preprocessing summary",
	)
	base.materialize_dataframe_table(
		ctx,
		df=raw_feature_manifest_df,
		table_name=base.artifact_name(ctx, "table_deephit_raw_feature_manifest"),
		block_number="5.15.2",
		label="Stage 5.15.2 table_deephit_raw_feature_manifest - Neural-DeepHit raw feature manifest",
	)
	base.materialize_dataframe_table(
		ctx,
		df=output_feature_manifest_df,
		table_name=base.artifact_name(ctx, "table_deephit_feature_names_out"),
		block_number="5.15.2",
		label="Stage 5.15.2 table_deephit_feature_names_out - Neural-DeepHit output feature manifest",
	)
	...
	preprocessing_config_path = ctx.metadata_dir / base.artifact_filename(ctx, "deephit_preprocessing_config.json")
	base.save_json(preprocessing_config, preprocessing_config_path)
	base.print_artifact("deephit_preprocessing_config", str(preprocessing_config_path))
	print(preprocessing_config_path.read_text(encoding="utf-8"))

	log_stage_end("5.15.2")
	return DeepHitTreatmentState(
		train_df=train_df,
		test_df=test_df,
		feature_columns=feature_columns,
		expected_features_raw=expected_features_raw,
...
def evaluate_continuous_survival(
	...
	for horizon_week in BENCHMARK_HORIZONS:
		...
		if horizon_predictions_df[["pred_survival_h", "pred_risk_h"]].isna().any().any():
			raise ValueError(f"The tuned Neural-DeepHit predictions contain missing values at horizon {horizon_week}.")
	...
	if not np.isfinite(max_ipcw_time):
		raise ValueError("Could not determine a valid censoring-support horizon for the Neural-DeepHit model.")
		...
		td_auc_audit_rows.append(
			{
				...
				"notes": "IPCW-supported subset used for Neural-DeepHit time-dependent AUC",
			}
		)
	...
	row_pred_survival = np.asarray(
		[
			float(survival_wide_df.loc[int(max(float(duration), DEEPHIT_MIN_DURATION)), enrollment_id])
	...
	if not np.isfinite(row_pred_risk).all():
		raise ValueError("The tuned Neural-DeepHit event-time risk diagnostics contain non-finite values.")
	if truth_test_df["event"].nunique() < 2:
		raise ValueError("The Neural-DeepHit test truth does not contain both event classes for row-level diagnostics.")
...
# ==============================================================
# 5.15.3 - Compute runtime guardrails for Neural-DeepHit
# ==============================================================
# What this block does:
...
# Outputs:
# - files generated: none
# - DuckDB tables created or updated: table_deephit_guardrails
# - objects returned in memory: DeepHitGuardrailState
def safe_deephit_row_budget(n_rows: int, n_features: int, requested_cap: int) -> int:
	_ = n_features
...
def build_deephit_target_arrays(truth_df: pd.DataFrame) -> tuple[np.ndarray, np.ndarray]:
	durations = np.maximum(truth_df["duration"].astype(float).to_numpy(), DEEPHIT_MIN_DURATION)
	events = truth_df["event"].astype(int).to_numpy()
	return durations.astype(np.float32), events.astype(np.int64)


def build_deephit_network(input_dim: int, candidate: dict[str, Any], out_features: int) -> tt.practical.MLPVanilla:
...
def normalize_deephit_survival_frame(
	...
	if raw_values.ndim != 2 or raw_values.shape[1] != len(enrollment_ids):
		raise ValueError("The Neural-DeepHit survival surface has an invalid shape.")
	...
	if survival_wide_df.isna().any().any():
		raise ValueError("The Neural-DeepHit survival surface contains missing values after normalization.")
	if not np.isfinite(survival_wide_df.to_numpy(dtype=float)).all():
		raise ValueError("The Neural-DeepHit survival surface contains non-finite values after normalization.")
	return survival_wide_df.clip(lower=0.0, upper=1.0)


def fit_deephit_candidate(
	X_subtrain: np.ndarray,
	truth_subtrain_df: pd.DataFrame,
	X_val: np.ndarray,
	truth_val_df: pd.DataFrame,
	...
	random_seed: int,
	device: str,
) -> tuple[dict[str, Any], pd.DataFrame, DeepHitSingle]:
	set_deterministic_state(random_seed)
	subtrain_durations, subtrain_events = build_deephit_target_arrays(truth_subtrain_df)
	val_durations, val_events = build_deephit_target_arrays(truth_val_df)
	labtrans = DeepHitSingle.label_transform(int(candidate["num_durations"]))
	y_subtrain = labtrans.fit_transform(subtrain_durations, subtrain_events)
	y_val = labtrans.transform(val_durations, val_events)
	net = build_deephit_network(input_dim=input_dim, candidate=candidate, out_features=int(labtrans.out_features))
	model = DeepHitSingle(
		net,
	...
	training_log = model.fit(
		...
		epochs=int(DEEPHIT_MAX_EPOCHS),
		verbose=False,
		val_data=(np.asarray(X_val, dtype=np.float32), y_val),
		callbacks=[tt.callbacks.EarlyStopping(patience=int(DEEPHIT_EARLY_STOPPING_PATIENCE))],
	)
	history_df = training_log.to_pandas().reset_index(drop=True)
	if history_df.empty or "val_loss" not in history_df.columns:
		raise RuntimeError(f"DeepHit tuning candidate {candidate['candidate_id']} did not produce a usable validation history.")
	...
	val_survival_df = normalize_deephit_survival_frame(
...
def build_deephit_guardrails(ctx: PipelineContext, treatment: DeepHitTreatmentState) -> DeepHitGuardrailState:
	log_stage_start("5.15.3", "Compute runtime guardrails for Neural-DeepHit")
	...
	truth_subtrain_df = base.build_truth_by_enrollment(treatment.train_df.iloc[train_internal_idx], "deephit_validation_subtrain")
	truth_val_df = base.build_truth_by_enrollment(treatment.train_df.iloc[val_internal_idx], "deephit_validation_holdout")
	X_subtrain_full = base.align_feature_matrix(
		...
		matrix_name="Neural-DeepHit subtrain matrix",
	)
	X_val = base.align_feature_matrix(
		...
		val_raw_ids,
		truth_val_df["enrollment_id"].astype(str).tolist(),
		matrix_name="Neural-DeepHit validation matrix",
	)
	X_train_full_all = base.align_feature_matrix(
		...
		matrix_name="Neural-DeepHit full-train matrix",
	)
	X_test_aligned = base.align_feature_matrix(
		...
		matrix_name="Neural-DeepHit test matrix",
	)

	search_row_cap = safe_deephit_row_budget(X_subtrain_full.shape[0], X_subtrain_full.shape[1], DEEPHIT_SEARCH_ROW_CAP)
	final_row_cap = safe_deephit_row_budget(X_train_full_all.shape[0], X_train_full_all.shape[1], DEEPHIT_FINAL_ROW_CAP)
	...
	base.materialize_dataframe_table(
		...
		table_name=base.artifact_name(ctx, "table_deephit_guardrails"),
		block_number="5.15.3",
		label="Stage 5.15.3 table_deephit_guardrails - Neural-DeepHit runtime guardrails",
	)
	log_stage_end("5.15.3")
	return DeepHitGuardrailState(
...
# ==============================================================
# 5.15.4 - Tune, fit, evaluate, and persist the Neural-DeepHit model
# ==============================================================
# What this block does:
# - Tunes the compact Neural-DeepHit grid on the grouped validation split, fits the best model on the full training treatment, evaluates the resulting survival functions, and persists all outputs.
# Inputs:
# - files read: none
# - DuckDB tables read: enrollment_cox_ready_train, enrollment_cox_ready_test
# - configuration values used: benchmark.seed, validation split policy, tuning grid, benchmark horizons, calibration bins
# Outputs:
# - files generated: outputs_benchmark_survival/metadata/deephit_tuned_model_config.json, outputs_benchmark_survival/models/deephit_tuned.pt, outputs_benchmark_survival/models/deephit_preprocessor.joblib
# - DuckDB tables created or updated: table_deephit_tuning_results, table_deephit_tuned_test_predictions, table_deephit_tuned_primary_metrics, table_deephit_tuned_brier_by_horizon, table_deephit_tuned_secondary_metrics, table_deephit_tuned_td_auc_support_audit, table_deephit_tuned_row_diagnostics, table_deephit_tuned_support_by_horizon, table_deephit_tuned_calibration_summary, table_deephit_tuned_calibration_bins_by_horizon, table_deephit_tuned_predicted_vs_observed_survival
# - objects returned in memory: none
def tune_and_evaluate_deephit_model(
	ctx: PipelineContext,
	treatment: DeepHitTreatmentState,
	guardrails: DeepHitGuardrailState,
) -> None:
	log_stage_start("5.15.4", "Tune and evaluate the Neural-DeepHit model")
	...
	for candidate in DEEPHIT_TUNING_GRID:
		candidate_row, history_df, _ = fit_deephit_candidate(
	...
	if best_candidate is None or best_history_df is None:
		raise RuntimeError("The Neural-DeepHit tuning grid did not produce a best candidate.")
	...
	survival_wide_df = normalize_deephit_survival_frame(
	...
	model_path = ctx.models_dir / base.artifact_filename(ctx, "deephit_tuned.pt")
	preprocessor_path = ctx.models_dir / base.artifact_filename(ctx, "deephit_preprocessor.joblib")
	config_path = ctx.metadata_dir / base.artifact_filename(ctx, "deephit_tuned_model_config.json")
	...
	base.materialize_dataframe_table(
		...
		table_name=base.artifact_name(ctx, "table_deephit_tuning_results"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuning_results - Neural-DeepHit tuning results",
	)
	base.materialize_dataframe_table(
		ctx,
		df=training_history_df,
		table_name=base.artifact_name(ctx, "table_deephit_tuned_training_history"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_training_history - Neural-DeepHit training history",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["test_predictions_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_test_predictions"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_test_predictions - Neural-DeepHit test predictions",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["primary_metrics_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_primary_metrics"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_primary_metrics - Neural-DeepHit primary metrics",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["brier_by_horizon_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_brier_by_horizon"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_brier_by_horizon - Neural-DeepHit Brier scores by horizon",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["secondary_metrics_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_secondary_metrics"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_secondary_metrics - Neural-DeepHit secondary metrics",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["td_auc_support_audit_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_td_auc_support_audit"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_td_auc_support_audit - Neural-DeepHit IPCW support audit",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["row_diagnostics_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_row_diagnostics"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_row_diagnostics - Neural-DeepHit row-level diagnostics",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["support_by_horizon_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_support_by_horizon"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_support_by_horizon - Neural-DeepHit support by horizon",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["calibration_summary_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_calibration_summary"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_calibration_summary - Neural-DeepHit calibration summary",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["calibration_bins_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_calibration_bins_by_horizon"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_calibration_bins_by_horizon - Neural-DeepHit calibration bins",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["predicted_vs_observed_survival_df"],
		table_name=base.artifact_name(ctx, "table_deephit_tuned_predicted_vs_observed_survival"),
		block_number="5.15.4",
		label="Stage 5.15.4 table_deephit_tuned_predicted_vs_observed_survival - Neural-DeepHit predicted versus observed survival",
	)
	...
	config_payload = {
		...
		"variance_filter_threshold": float(LOW_VARIANCE_THRESHOLD),
		"min_duration": float(DEEPHIT_MIN_DURATION),
		"max_epochs": int(DEEPHIT_MAX_EPOCHS),
		"early_stopping_patience": int(DEEPHIT_EARLY_STOPPING_PATIENCE),
		"device": device,
		...
		"design_note": (
			"The comparable Neural-DeepHit arm preserves the canonical early-window contract, "
			"uses deterministic train-only preprocessing, discretizes survival times through pycox LabTransDiscreteTime, "
			"and reconstructs the full weekly survival surface from the tuned DeepHit network under validation IBS."
		),
	}
	base.save_json(config_payload, config_path)
	base.print_artifact("deephit_model", str(model_path))
	base.print_artifact("deephit_preprocessor", str(preprocessor_path))
	base.print_artifact("deephit_tuned_model_config", str(config_path))
	print(config_path.read_text(encoding="utf-8"))
	print(pd.DataFrame([best_candidate]).to_string(index=False))

	log_stage_end("5.15.4")


# ==============================================================
# 5.15.5 - Close runtime resources
# ==============================================================
# What this block does:
# - Closes the DuckDB connection after all Neural-DeepHit artifacts have been materialized.
# Inputs:
# - files read: none
...
def run_single_window(window_weeks: int) -> None:
	...
	try:
		...
		treatment = build_deephit_treatment(ctx)
		guardrails = build_deephit_guardrails(ctx, treatment)
		tune_and_evaluate_deephit_model(ctx, treatment, guardrails)
	finally:
		if ctx is not None:
			close_context(ctx)
