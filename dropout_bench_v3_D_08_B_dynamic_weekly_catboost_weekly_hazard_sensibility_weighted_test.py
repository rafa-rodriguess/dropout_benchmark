...
"""
Production weighted CatBoost weekly hazard benchmark module for Item 6 sensitivity.
...
Expected outputs:
- DuckDB tables table_catboost_weekly_hazard_weighted_preprocessing_summary,
  table_catboost_weekly_hazard_weighted_raw_feature_manifest,
  table_catboost_weekly_hazard_weighted_feature_names_out,
  table_catboost_weekly_hazard_weighted_guardrails,
  table_catboost_weekly_hazard_weighted_tuning_results,
  table_catboost_weekly_hazard_weighted_tuned_test_predictions,
  table_catboost_weekly_hazard_weighted_tuned_primary_metrics,
  table_catboost_weekly_hazard_weighted_tuned_brier_by_horizon,
  table_catboost_weekly_hazard_weighted_tuned_secondary_metrics,
  table_catboost_weekly_hazard_weighted_tuned_td_auc_support_audit,
  table_catboost_weekly_hazard_weighted_tuned_row_diagnostics,
  table_catboost_weekly_hazard_weighted_tuned_support_by_horizon,
  table_catboost_weekly_hazard_weighted_tuned_calibration_summary,
  table_catboost_weekly_hazard_weighted_tuned_calibration_bins_by_horizon,
  table_catboost_weekly_hazard_weighted_tuned_predicted_vs_observed_survival
- outputs_benchmark_survival/metadata/catboost_weekly_hazard_weighted_preprocessing_config.json
- outputs_benchmark_survival/metadata/catboost_weekly_hazard_weighted_tuned_model_config.json
- outputs_benchmark_survival/models/catboost_weekly_hazard_weighted_tuned.cbm
...
- table_catboost_weekly_hazard_weighted_preprocessing_summary
- table_catboost_weekly_hazard_weighted_raw_feature_manifest
- table_catboost_weekly_hazard_weighted_feature_names_out
- table_catboost_weekly_hazard_weighted_guardrails
- table_catboost_weekly_hazard_weighted_tuning_results
...
NOTEBOOK_NAME = "dropout_bench_v3_D_5_8_weighted.ipynb"
MODEL_NAME = "catboost_weekly_hazard_weighted_tuned"
MODEL_TYPE = "catboost_weekly_hazard"
PREPROCESSING_CONFIG_NAME = "catboost_weekly_hazard_weighted_preprocessing_config.json"
MODEL_CONFIG_NAME = "catboost_weekly_hazard_weighted_tuned_model_config.json"
MODEL_ARTIFACT_NAME = "catboost_weekly_hazard_weighted_tuned.cbm"
...
# Outputs:
# - files generated: outputs_benchmark_survival/metadata/catboost_weekly_hazard_weighted_preprocessing_config.json
# - DuckDB tables created or updated: table_catboost_weekly_hazard_weighted_preprocessing_summary, table_catboost_weekly_hazard_weighted_raw_feature_manifest, table_catboost_weekly_hazard_weighted_feature_names_out
...
def build_catboost_treatment(ctx: base.PipelineContext, window_weeks: int) -> CatBoostTreatmentState:
	...
	base.materialize_dataframe_table(
		...
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_preprocessing_summary", window_weeks),
		block_number="5.8.2",
		label=f"Stage 5.8.2 {apply_name_suffix('table_catboost_weekly_hazard_weighted_preprocessing_summary', output_table_suffix)} — CatBoost preprocessing summary",
	)
	base.materialize_dataframe_table(
		ctx,
		df=feature_manifest_df,
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_raw_feature_manifest", window_weeks),
		block_number="5.8.2",
		label=f"Stage 5.8.2 {apply_name_suffix('table_catboost_weekly_hazard_weighted_raw_feature_manifest', output_table_suffix)} — CatBoost raw feature manifest",
	)
	base.materialize_dataframe_table(
		ctx,
		df=feature_names_df,
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_feature_names_out", window_weeks),
		block_number="5.8.2",
		label=f"Stage 5.8.2 {apply_name_suffix('table_catboost_weekly_hazard_weighted_feature_names_out', output_table_suffix)} — CatBoost model feature names",
	)
...
# Outputs:
# - files generated: none
# - DuckDB tables created or updated: table_catboost_weekly_hazard_weighted_guardrails
...
def build_validation_split(ctx: base.PipelineContext, treatment: CatBoostTreatmentState, window_weeks: int) -> ValidationSplitState:
	...
	summary = {
		...
		"sample_weight_strategy": "catboost class_weights",
	...
	base.materialize_dataframe_table(
		ctx,
		df=guardrails_df,
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_guardrails", window_weeks),
		block_number="5.8.3",
		label=f"Stage 5.8.3 {apply_name_suffix('table_catboost_weekly_hazard_weighted_guardrails', output_table_suffix)} — CatBoost validation guardrails",
	)
...
# Outputs:
# - files generated: outputs_benchmark_survival/metadata/catboost_weekly_hazard_weighted_tuned_model_config.json, outputs_benchmark_survival/models/catboost_weekly_hazard_weighted_tuned.cbm
# - DuckDB tables created or updated: table_catboost_weekly_hazard_weighted_tuning_results, table_catboost_weekly_hazard_weighted_tuned_test_predictions, table_catboost_weekly_hazard_weighted_tuned_primary_metrics, table_catboost_weekly_hazard_weighted_tuned_brier_by_horizon, table_catboost_weekly_hazard_weighted_tuned_secondary_metrics, table_catboost_weekly_hazard_weighted_tuned_td_auc_support_audit, table_catboost_weekly_hazard_weighted_tuned_row_diagnostics, table_catboost_weekly_hazard_weighted_tuned_support_by_horizon, table_catboost_weekly_hazard_weighted_tuned_calibration_summary, table_catboost_weekly_hazard_weighted_tuned_calibration_bins_by_horizon, table_catboost_weekly_hazard_weighted_tuned_predicted_vs_observed_survival
...
def tune_fit_evaluate_catboost(
	...
	for candidate_id, params in enumerate(CANDIDATE_GRID, start=1):
		model = CatBoostClassifier(
			...
			eval_metric="Logloss",
			class_weights=[1.0, float(split_state.summary["positive_weight_subtrain"])],
		...
		candidate_record = {
			...
			"positive_weight": float(split_state.summary["positive_weight_subtrain"]),
	...
	final_model = CatBoostClassifier(
		loss_function="Logloss",
		eval_metric="Logloss",
		class_weights=[1.0, float(split_state.summary["positive_weight_full"])],
		random_seed=ctx.random_seed,
		verbose=False,
		allow_writing_files=False,
		thread_count=ctx.cpu_cores,
	...
	base.materialize_dataframe_table(
		...
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuning_results", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuning_results', output_table_suffix)} — CatBoost tuning results",
	)
	base.materialize_dataframe_table(
		ctx,
		df=test_predictions_df,
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_test_predictions", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_test_predictions', output_table_suffix)} — CatBoost test predictions",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["primary_metrics_df"],
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_primary_metrics", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_primary_metrics', output_table_suffix)} — CatBoost primary metrics",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["brier_by_horizon_df"],
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_brier_by_horizon", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_brier_by_horizon', output_table_suffix)} — CatBoost Brier scores by horizon",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["secondary_metrics_df"],
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_secondary_metrics", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_secondary_metrics', output_table_suffix)} — CatBoost secondary metrics",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["td_auc_support_audit_df"],
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_td_auc_support_audit", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_td_auc_support_audit', output_table_suffix)} — CatBoost IPCW support audit",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["row_diagnostics_df"],
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_row_diagnostics", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_row_diagnostics', output_table_suffix)} — CatBoost row-level diagnostics",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["support_by_horizon_df"],
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_support_by_horizon", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_support_by_horizon', output_table_suffix)} — CatBoost support by horizon",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["calibration_summary_df"],
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_calibration_summary", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_calibration_summary', output_table_suffix)} — CatBoost calibration summary",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["calibration_bins_df"],
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_calibration_bins_by_horizon", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_calibration_bins_by_horizon', output_table_suffix)} — CatBoost calibration bins",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["predicted_vs_observed_survival_df"],
		table_name=apply_window_table_name("table_catboost_weekly_hazard_weighted_tuned_predicted_vs_observed_survival", window_weeks),
		block_number="5.8.5",
		label=f"Stage 5.8.5 {apply_name_suffix('table_catboost_weekly_hazard_weighted_tuned_predicted_vs_observed_survival', output_table_suffix)} — CatBoost predicted versus observed survival",
	)
	...
	config_payload = {
		...
		"weighting_strategy": "CatBoost class weights are derived from the guarded positive-class imbalance ratio on sampled person-period rows.",
		"design_note": "The weighted CatBoost benchmark preserves native categorical columns and the same dynamic feature contract while applying positive-class weighting for Item 6 sensitivity.",
	}
	base.save_json(config_payload, config_path)
	base.print_artifact("catboost_weekly_hazard_model", str(model_path))
	base.print_artifact("catboost_weekly_hazard_weighted_tuned_model_config", str(config_path))
