...
"""
Production gradient-boosted Cox benchmark module for stage D5.10.

What this file does:
- prepares the comparable-window continuous-time treatment directly from DuckDB-ready enrollment tables
- applies deterministic preprocessing and feature validation for the gradient-boosted Cox model
- tunes and fits the gradient-boosted Cox benchmark under the official grouped validation protocol
...
- materialize the full comparable nonlinear Cox-boosting benchmark arm deterministically from DuckDB-ready tables without notebook runtime state, CSV workflows, or hidden execution state
...
Expected outputs:
- DuckDB tables table_gb_cox_preprocessing_summary, table_gb_cox_raw_feature_manifest,
	table_gb_cox_feature_names_out, table_gb_cox_guardrails, table_gb_cox_tuning_results,
  table_gb_cox_tuned_test_predictions, table_gb_cox_tuned_primary_metrics,
  table_gb_cox_tuned_brier_by_horizon, table_gb_cox_tuned_secondary_metrics,
  table_gb_cox_tuned_td_auc_support_audit, table_gb_cox_tuned_row_diagnostics,
  table_gb_cox_tuned_support_by_horizon, table_gb_cox_tuned_calibration_summary,
  table_gb_cox_tuned_calibration_bins_by_horizon,
  table_gb_cox_tuned_predicted_vs_observed_survival
- outputs_benchmark_survival/metadata/gb_cox_preprocessing_config.json
- outputs_benchmark_survival/metadata/gb_cox_tuned_model_config.json
- outputs_benchmark_survival/models/gb_cox_tuned.joblib
- outputs_benchmark_survival/models/gb_cox_preprocessor.joblib
...
- table_gb_cox_preprocessing_summary
- table_gb_cox_raw_feature_manifest
- table_gb_cox_feature_names_out
- table_gb_cox_guardrails
- table_gb_cox_tuning_results
- table_gb_cox_tuned_test_predictions
- table_gb_cox_tuned_primary_metrics
- table_gb_cox_tuned_brier_by_horizon
- table_gb_cox_tuned_secondary_metrics
- table_gb_cox_tuned_td_auc_support_audit
- table_gb_cox_tuned_row_diagnostics
- table_gb_cox_tuned_support_by_horizon
- table_gb_cox_tuned_calibration_summary
- table_gb_cox_tuned_calibration_bins_by_horizon
- table_gb_cox_tuned_predicted_vs_observed_survival
- pipeline_table_catalog
...
NOTEBOOK_NAME = "dropout_bench_D_v5_10_gradient_boosted_cox.ipynb"
MODEL_NAME = "gb_cox_tuned"
PREVIEW_ROWS = 20
...
GB_COX_SEARCH_ROW_CAP = 4000
GB_COX_FINAL_ROW_CAP = 6000
...
GB_COX_TUNING_GRID = (
	{"candidate_id": 1,  "loss": "coxph", "learning_rate": 0.02, "n_estimators": 100, "max_depth": 1, "subsample": 1.0},
	{"candidate_id": 2,  "loss": "coxph", "learning_rate": 0.03, "n_estimators": 150, "max_depth": 1, "subsample": 1.0},
	{"candidate_id": 3,  "loss": "coxph", "learning_rate": 0.05, "n_estimators": 150, "max_depth": 1, "subsample": 1.0},
	{"candidate_id": 4,  "loss": "coxph", "learning_rate": 0.05, "n_estimators": 250, "max_depth": 1, "subsample": 0.8},
	{"candidate_id": 5,  "loss": "coxph", "learning_rate": 0.08, "n_estimators": 150, "max_depth": 1, "subsample": 0.8},
	{"candidate_id": 6,  "loss": "coxph", "learning_rate": 0.10, "n_estimators": 100, "max_depth": 1, "subsample": 1.0},
	{"candidate_id": 7,  "loss": "coxph", "learning_rate": 0.10, "n_estimators": 150, "max_depth": 1, "subsample": 0.8},
	{"candidate_id": 8,  "loss": "coxph", "learning_rate": 0.10, "n_estimators": 300, "max_depth": 1, "subsample": 0.8},
	{"candidate_id": 9,  "loss": "coxph", "learning_rate": 0.02, "n_estimators": 200, "max_depth": 2, "subsample": 1.0},
	{"candidate_id": 10, "loss": "coxph", "learning_rate": 0.03, "n_estimators": 200, "max_depth": 2, "subsample": 1.0},
	{"candidate_id": 11, "loss": "coxph", "learning_rate": 0.05, "n_estimators": 200, "max_depth": 2, "subsample": 1.0},
	{"candidate_id": 12, "loss": "coxph", "learning_rate": 0.05, "n_estimators": 250, "max_depth": 2, "subsample": 0.8},
	{"candidate_id": 13, "loss": "coxph", "learning_rate": 0.08, "n_estimators": 200, "max_depth": 2, "subsample": 0.8},
	{"candidate_id": 14, "loss": "coxph", "learning_rate": 0.08, "n_estimators": 250, "max_depth": 2, "subsample": 0.8},
	{"candidate_id": 15, "loss": "coxph", "learning_rate": 0.10, "n_estimators": 150, "max_depth": 2, "subsample": 1.0},
	{"candidate_id": 16, "loss": "coxph", "learning_rate": 0.10, "n_estimators": 300, "max_depth": 2, "subsample": 0.8},
	{"candidate_id": 17, "loss": "coxph", "learning_rate": 0.02, "n_estimators": 300, "max_depth": 3, "subsample": 1.0},
	{"candidate_id": 18, "loss": "coxph", "learning_rate": 0.03, "n_estimators": 250, "max_depth": 3, "subsample": 1.0},
	{"candidate_id": 19, "loss": "coxph", "learning_rate": 0.05, "n_estimators": 200, "max_depth": 3, "subsample": 0.8},
	{"candidate_id": 20, "loss": "coxph", "learning_rate": 0.05, "n_estimators": 300, "max_depth": 3, "subsample": 1.0},
	{"candidate_id": 21, "loss": "coxph", "learning_rate": 0.08, "n_estimators": 150, "max_depth": 3, "subsample": 0.8},
	{"candidate_id": 22, "loss": "coxph", "learning_rate": 0.08, "n_estimators": 300, "max_depth": 3, "subsample": 0.8},
	{"candidate_id": 23, "loss": "coxph", "learning_rate": 0.10, "n_estimators": 100, "max_depth": 3, "subsample": 0.8},
	{"candidate_id": 24, "loss": "coxph", "learning_rate": 0.10, "n_estimators": 200, "max_depth": 3, "subsample": 0.8},
)
...
# ==============================================================
# 5.10.1 - Lightweight runtime bootstrap
# ==============================================================
# What this block does:
# - Initializes shared paths, configuration objects, run metadata, and the DuckDB connection for the D5.10 stage.
# Inputs:
...
def initialize_context(window_weeks: int) -> PipelineContext:
	...
	log_stage_start("5.10.1", "Lightweight runtime bootstrap")
	...
	base.require_tables(con, [input_train_table, input_test_table], block_number="5.10.1")
	...
	log_stage_end("5.10.1")
	return ctx


# ==============================================================
# 5.10.2 - Build the comparable gradient-boosted Cox treatment
# ==============================================================
# What this block does:
...
# Outputs:
# - files generated: outputs_benchmark_survival/metadata/gb_cox_preprocessing_config.json, outputs_benchmark_survival/models/gb_cox_preprocessor.joblib
# - DuckDB tables created or updated: table_gb_cox_preprocessing_summary, table_gb_cox_raw_feature_manifest, table_gb_cox_feature_names_out
# - objects returned in memory: GBCoxTreatmentState
def build_gb_cox_treatment(ctx: PipelineContext) -> GBCoxTreatmentState:
	log_stage_start("5.10.2", "Build comparable gradient-boosted Cox treatment")
	...
	if sorted(expected_numeric_features) != sorted(numeric_features):
		raise ValueError(
			"The comparable gradient-boosted Cox numeric feature specification does not match the canonical modeling contract. "
	...
	train_df = base.load_required_table(ctx, ctx.input_train_table, required_columns, block_number="5.10.2")
	test_df = base.load_required_table(ctx, ctx.input_test_table, required_columns, block_number="5.10.2")
	...
	if X_train.ndim != 2 or X_test.ndim != 2:
		raise ValueError(f"The gradient-boosted Cox transformed matrices must be 2D. Got train={X_train.shape}, test={X_test.shape}.")
	if not np.isfinite(X_train).all() or not np.isfinite(X_test).all():
		raise ValueError("The gradient-boosted Cox transformed matrices contain non-finite values.")
	...
	preprocessing_summary_df = pd.DataFrame(
		[
			{
				"model_family": "gradient_boosted_cox",
				...
				"model_positioning_note": "early-window comparable gradient-boosted Cox benchmark",
	...
	base.materialize_dataframe_table(
		...
		table_name=base.artifact_name(ctx, "table_gb_cox_preprocessing_summary"),
		block_number="5.10.2",
		label="Stage 5.10.2 table_gb_cox_preprocessing_summary - Gradient-boosted Cox preprocessing summary",
	)
	base.materialize_dataframe_table(
		ctx,
		df=raw_feature_manifest_df,
		table_name=base.artifact_name(ctx, "table_gb_cox_raw_feature_manifest"),
		block_number="5.10.2",
		label="Stage 5.10.2 table_gb_cox_raw_feature_manifest - Gradient-boosted Cox raw feature manifest",
	)
	base.materialize_dataframe_table(
		ctx,
		df=output_feature_manifest_df,
		table_name=base.artifact_name(ctx, "table_gb_cox_feature_names_out"),
		block_number="5.10.2",
		label="Stage 5.10.2 table_gb_cox_feature_names_out - Gradient-boosted Cox output feature manifest",
	)
	...
	preprocessing_config_path = ctx.metadata_dir / base.artifact_filename(ctx, "gb_cox_preprocessing_config.json")
	base.save_json(preprocessing_config, preprocessing_config_path)
	base.print_artifact("gb_cox_preprocessing_config", str(preprocessing_config_path))
	print(preprocessing_config_path.read_text(encoding="utf-8"))

	log_stage_end("5.10.2")
	return GBCoxTreatmentState(
		train_df=train_df,
		test_df=test_df,
		feature_columns=feature_columns,
		expected_features_raw=expected_features_raw,
...
def evaluate_continuous_survival(
	...
	for horizon_week in BENCHMARK_HORIZONS:
		...
		if horizon_predictions_df[["pred_survival_h", "pred_risk_h"]].isna().any().any():
			raise ValueError(f"The tuned gradient-boosted Cox predictions contain missing values at horizon {horizon_week}.")
	...
	if not np.isfinite(max_ipcw_time):
		raise ValueError("Could not determine a valid censoring-support horizon for the gradient-boosted Cox model.")
		...
		td_auc_audit_rows.append(
			{
				...
				"notes": "IPCW-supported subset used for gradient-boosted Cox time-dependent AUC",
			}
		)
	...
	if not np.isfinite(row_pred_risk).all():
		raise ValueError("The tuned gradient-boosted Cox event-time risk diagnostics contain non-finite values.")
	if truth_test_df["event"].nunique() < 2:
		raise ValueError("The gradient-boosted Cox test truth does not contain both event classes for row-level diagnostics.")
...
# ==============================================================
# 5.10.3 - Compute runtime guardrails for gradient boosting
# ==============================================================
# What this block does:
...
# Outputs:
# - files generated: none
# - DuckDB tables created or updated: table_gb_cox_guardrails
# - objects returned in memory: GBCoxGuardrailState
def safe_gb_cox_row_budget(n_rows: int, n_features: int, requested_cap: int) -> int:
	feature_adjusted_cap = max(4000, int(250000 / max(1, n_features)))
...
def build_gb_cox_guardrails(ctx: PipelineContext, treatment: GBCoxTreatmentState) -> GBCoxGuardrailState:
	log_stage_start("5.10.3", "Compute runtime guardrails for gradient boosting")
	...
	truth_subtrain_df = base.build_truth_by_enrollment(treatment.train_df.iloc[train_internal_idx], "gb_cox_validation_subtrain")
	truth_val_df = base.build_truth_by_enrollment(treatment.train_df.iloc[val_internal_idx], "gb_cox_validation_holdout")
	X_subtrain_full = base.align_feature_matrix(
		...
		matrix_name="Gradient-boosted Cox subtrain matrix",
	)
	X_val = base.align_feature_matrix(
		...
		matrix_name="Gradient-boosted Cox validation matrix",
	)
	X_train_full_all = base.align_feature_matrix(
		...
		matrix_name="Gradient-boosted Cox full-train matrix",
	)
	X_test_aligned = base.align_feature_matrix(
		...
		matrix_name="Gradient-boosted Cox test matrix",
	)

	search_row_cap = safe_gb_cox_row_budget(X_subtrain_full.shape[0], X_subtrain_full.shape[1], GB_COX_SEARCH_ROW_CAP)
	final_row_cap = safe_gb_cox_row_budget(X_train_full_all.shape[0], X_train_full_all.shape[1], GB_COX_FINAL_ROW_CAP)
	...
	base.materialize_dataframe_table(
		...
		table_name=base.artifact_name(ctx, "table_gb_cox_guardrails"),
		block_number="5.10.3",
		label="Stage 5.10.3 table_gb_cox_guardrails - Gradient-boosted Cox runtime guardrails",
	)
	log_stage_end("5.10.3")
	return GBCoxGuardrailState(
...
# ==============================================================
# 5.10.4 - Tune, fit, evaluate, and persist the gradient-boosted Cox model
# ==============================================================
# What this block does:
# - Tunes the compact gradient-boosted Cox grid on the grouped validation split, fits the best model on the full training treatment, evaluates the resulting survival functions, and persists all outputs.
# Inputs:
# - files read: none
# - DuckDB tables read: enrollment_cox_ready_train, enrollment_cox_ready_test
# - configuration values used: benchmark.seed, validation split policy, tuning grid, benchmark horizons, calibration bins
# Outputs:
# - files generated: outputs_benchmark_survival/metadata/gb_cox_tuned_model_config.json, outputs_benchmark_survival/models/gb_cox_tuned.joblib, outputs_benchmark_survival/models/gb_cox_preprocessor.joblib
# - DuckDB tables created or updated: table_gb_cox_tuning_results, table_gb_cox_tuned_test_predictions, table_gb_cox_tuned_primary_metrics, table_gb_cox_tuned_brier_by_horizon, table_gb_cox_tuned_secondary_metrics, table_gb_cox_tuned_td_auc_support_audit, table_gb_cox_tuned_row_diagnostics, table_gb_cox_tuned_support_by_horizon, table_gb_cox_tuned_calibration_summary, table_gb_cox_tuned_calibration_bins_by_horizon, table_gb_cox_tuned_predicted_vs_observed_survival
# - objects returned in memory: none
def tune_and_evaluate_gb_cox_model(
	ctx: PipelineContext,
	treatment: GBCoxTreatmentState,
	guardrails: GBCoxGuardrailState,
) -> None:
	from dropout_bench_v3_A_2_runtime_config import resolve_runtime_tuning_parallel_backend

	log_stage_start("5.10.4", "Tune and evaluate the gradient-boosted Cox model")

	y_subtrain = Surv.from_arrays(
		event=guardrails.truth_subtrain_df.iloc[guardrails.subtrain_sample_idx]["event"].astype(bool).to_numpy(),
		time=guardrails.truth_subtrain_df.iloc[guardrails.subtrain_sample_idx]["duration"].astype(float).to_numpy(),
	)
	random_seed = int(ctx.random_seed)

	tuning_workers = max(1, min(int(ctx.cpu_cores), len(GB_COX_TUNING_GRID)))
	...
	def evaluate_candidate(candidate: dict[str, Any]) -> dict[str, Any]:
		candidate_model = GradientBoostingSurvivalAnalysis(
		...
		candidate_model.fit(guardrails.X_subtrain[guardrails.subtrain_sample_idx], y_subtrain)
		val_time_grid = np.arange(0, int(max(guardrails.truth_val_df["duration"].max(), max(BENCHMARK_HORIZONS))) + 1, dtype=float)
		val_survival_df = base.surv_functions_to_frame(
			list(candidate_model.predict_survival_function(guardrails.X_val)),
	...
	tuning_rows = joblib.Parallel(n_jobs=tuning_workers, prefer=tuning_parallel_backend)(
		...
		for candidate in GB_COX_TUNING_GRID
	)
	...
	best_candidate = None if best_candidate_row is None else {
		...
		"params": {
			"loss": str(best_candidate_row["loss"]),
			"learning_rate": float(best_candidate_row["learning_rate"]),
			"n_estimators": int(best_candidate_row["n_estimators"]),
			"max_depth": int(best_candidate_row["max_depth"]),
			"subsample": float(best_candidate_row["subsample"]),
		},
	...
	if best_candidate is None:
		raise RuntimeError("The gradient-boosted Cox tuning grid did not produce a best candidate.")
	...
	y_train_full = Surv.from_arrays(
		event=treatment.truth_train_df.iloc[guardrails.full_sample_idx]["event"].astype(bool).to_numpy(),
		time=treatment.truth_train_df.iloc[guardrails.full_sample_idx]["duration"].astype(float).to_numpy(),
	)
	...
	best_model.fit(guardrails.X_train_full[guardrails.full_sample_idx], y_train_full)

	gb_cox_time_grid = np.arange(0, int(max(treatment.truth_test_df["duration"].max(), max(BENCHMARK_HORIZONS))) + 1, dtype=float)
	survival_wide_df = base.surv_functions_to_frame(
		list(best_model.predict_survival_function(guardrails.X_test_aligned)),
		treatment.truth_test_df["enrollment_id"].astype(str).tolist(),
		gb_cox_time_grid,
	)
	if survival_wide_df.isna().any().any():
		raise ValueError("The tuned gradient-boosted Cox survival surface contains missing values after enrollment alignment.")
	...
	model_path = ctx.models_dir / base.artifact_filename(ctx, "gb_cox_tuned.joblib")
	preprocessor_path = ctx.models_dir / base.artifact_filename(ctx, "gb_cox_preprocessor.joblib")
	config_path = ctx.metadata_dir / base.artifact_filename(ctx, "gb_cox_tuned_model_config.json")
	...
	base.materialize_dataframe_table(
		...
		table_name=base.artifact_name(ctx, "table_gb_cox_tuning_results"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuning_results - Gradient-boosted Cox tuning results",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["test_predictions_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_test_predictions"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_test_predictions - Gradient-boosted Cox test predictions",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["primary_metrics_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_primary_metrics"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_primary_metrics - Gradient-boosted Cox primary metrics",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["brier_by_horizon_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_brier_by_horizon"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_brier_by_horizon - Gradient-boosted Cox Brier scores by horizon",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["secondary_metrics_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_secondary_metrics"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_secondary_metrics - Gradient-boosted Cox secondary metrics",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["td_auc_support_audit_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_td_auc_support_audit"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_td_auc_support_audit - Gradient-boosted Cox IPCW support audit",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["row_diagnostics_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_row_diagnostics"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_row_diagnostics - Gradient-boosted Cox row-level diagnostics",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["support_by_horizon_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_support_by_horizon"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_support_by_horizon - Gradient-boosted Cox support by horizon",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["calibration_summary_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_calibration_summary"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_calibration_summary - Gradient-boosted Cox calibration summary",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["calibration_bins_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_calibration_bins_by_horizon"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_calibration_bins_by_horizon - Gradient-boosted Cox calibration bins",
	)
	base.materialize_dataframe_table(
		ctx,
		df=artifacts["predicted_vs_observed_survival_df"],
		table_name=base.artifact_name(ctx, "table_gb_cox_tuned_predicted_vs_observed_survival"),
		block_number="5.10.4",
		label="Stage 5.10.4 table_gb_cox_tuned_predicted_vs_observed_survival - Gradient-boosted Cox predicted versus observed survival",
	)
	...
	config_payload = {
		...
		"design_note": (
			"The comparable gradient-boosted Cox arm preserves the canonical early-window contract, "
			"uses deterministic train-only preprocessing, and tunes only the compact notebook-traceable Cox boosting grid under validation IBS."
		),
	}
	base.save_json(config_payload, config_path)
	base.print_artifact("gb_cox_model", str(model_path))
	base.print_artifact("gb_cox_preprocessor", str(preprocessor_path))
	base.print_artifact("gb_cox_tuned_model_config", str(config_path))
	print(config_path.read_text(encoding="utf-8"))
	print(pd.DataFrame([best_candidate]).to_string(index=False))

	log_stage_end("5.10.4")


# ==============================================================
# 5.10.5 - Close runtime resources
# ==============================================================
# What this block does:
# - Closes the DuckDB connection after all gradient-boosted Cox artifacts have been materialized.
# Inputs:
# - files read: none
...
def run_single_window(window_weeks: int) -> None:
	...
	try:
		...
		treatment = build_gb_cox_treatment(ctx)
		guardrails = build_gb_cox_guardrails(ctx, treatment)
		tune_and_evaluate_gb_cox_model(ctx, treatment, guardrails)
	finally:
		if ctx is not None:
			close_context(ctx)
